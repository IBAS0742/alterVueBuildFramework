import { homePageUrl,homePath,userPageUrl,baseUrl } from './variable'
...
export const VuePrototypeExtern = (Vue) => {
  ...
  Vue.prototype.homePageUrl = homePageUrl;
  Vue.prototype.homePath = homePath;
  Vue.prototype.userPageUrl = userPageUrl;
